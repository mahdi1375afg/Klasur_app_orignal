    ...
    static {
        try {
            ...
            if (!dataDir.exists()) {
                ...
                System.out.println("Datenbank-Verzeichnis erstellt: " + created);
            }
            System.out.println("Datenbank-Pfad: " + dataDir.getAbsolutePath());
        } catch (ClassNotFoundException e) {
            System.err.println("H2-Treiber nicht gefunden: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public static void sqlUpdate(String table, String[] column, Object[] value, String conditionColumn, Object conditionValue) throws SQLException {
        ...
        for (int i = 0; i < column.length; i++) {
            if (column[i].equalsIgnoreCase("zeit")) {
                ...
                setClause.append("isKorrekt = CAST(? AS boolean)");
            } else {
